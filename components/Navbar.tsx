      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="#contact"
              className="hidden md:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-success/30 bg-success/8 text-success text-xs font-medium hover:bg-success/15 hover:border-success/50 transition-all duration-200 group"
            >
